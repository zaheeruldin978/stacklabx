...
// --- 3. PREMIUM ANIMATED GRID BACKGROUND (Optimized for zero lag) ---
...
// --- 4. HIGHLY COLORFUL & OPTIMIZED MESH BACKGROUND ---
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0 flex items-center justify-center">
      <motion.div
        ...
        className="absolute w-[80vw] h-[80vh] max-w-[1000px] bg-gradient-to-tr from-cyan-500/40 via-blue-600/30 to-fuchsia-600/20 blur-[120px] rounded-full mix-blend-screen transform-gpu"
      />
      <motion.div
        animate={{ rotate: -360, opacity: [0.2, 0.4, 0.2] }}
        transition={{ duration: 50, repeat: Infinity, ease: "linear" }}
        className="absolute w-[70vw] h-[70vh] max-w-[900px] bg-gradient-to-bl from-indigo-500/30 via-purple-600/20 to-blue-500/20 blur-[130px] rounded-full mix-blend-screen transform-gpu"
      />
...
// --- 5. VIBRANT INTERACTIVE BENTO CARD (Updated for 3-Col Layout) ---
function VibrantCard({ title, desc, icon, colorGradient, laserColor }: { title: string, desc: string, icon: ReactNode, colorGradient: string, laserColor: string }) {
  ...
  return (
    ...
    >
      ...
      {/* Reduced padding (p-6) and scaled elements down slightly for a sleek 3-column fit */}
      <div className="relative z-10 h-full w-full bg-[#05070E]/90 backdrop-blur-2xl rounded-[30px] p-6 md:p-8 flex flex-col shadow-2xl overflow-hidden">
        <div className="relative z-20 flex flex-col h-full transform-gpu group-hover:translate-z-[15px] transition-transform duration-500">
  ...
  return (
    <div className="relative overflow-hidden selection:bg-cyan-500/30 bg-[#020308]">
      ...
      <section className="relative pt-[20vh] pb-24 z-10 max-w-7xl mx-auto px-6 min-h-[85vh] flex flex-col justify-center items-center text-center">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.4 }} className="text-lg md:text-xl text-slate-200 mb-12 leading-relaxed max-w-3xl font-light relative z-10 drop-shadow-md">
      ...
      {/* --- 4. SERVICE MATRIX (UPDATED TO 3-COLUMN GRID) --- */}
      <section className="py-32 relative z-10" id="capabilities">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20">
          ...
          {/* Changed grid-cols-2 to grid-cols-1 md:grid-cols-2 lg:grid-cols-3 for the beautiful 3x2 layout */}
          <motion.div style={{ y: yParallax }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            />
            {/* Added 2 new cards to complete the 3x2 grid beautifully */}
            <VibrantCard 
              title="Mobile Apps"
              desc="We develop stunning native and cross-platform mobile apps for iOS and Android that keep your customers engaged."
              colorGradient="from-violet-400 to-indigo-600"
              laserColor="rgba(139,92,246,1)"
            ...
            <VibrantCard 
              ...
              colorGradient="from-rose-400 to-red-600"
              laserColor="rgba(244,63,94,1)"
      ...
      <section className="py-32 relative z-10 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid md:grid-cols-3 gap-8">
            {[
              { tag: "MARKETING", color: "from-cyan-400 to-blue-600", title: "How a Fast Website Can Double Your Sales", desc: "Learn how modern design and fast loading speeds directly make customers want to buy from you." },
              { tag: "BUSINESS", color: "from-fuchsia-400 to-purple-600", title: "Why You Need Custom Software", desc: "Stop using messy spreadsheets. Discover how custom tools save you hours of manual work." },
              { tag: "SECURITY", color: "from-emerald-400 to-teal-500", title: "Protecting Your Online Business", desc: "A simple guide to keeping your customer data safe and preventing cyber attacks on your website." }
            ].map((article, i) => (
              <motion.div variants={fadeUp} key={i} className="h-full">
                <Link href="/blog" className="group block rounded-[32px] p-6 border border-white/5 bg-[#05070E] hover:border-white/20 transition-all duration-500 hover:-translate-y-2 shadow-xl h-full flex flex-col">
                  ...
                  <p className="text-slate-300 text-base font-light leading-relaxed flex-grow">{article.desc}</p>
                </Link>
              </motion.div>
            ))}
          </motion.div>
